...
import * as sty from "./PlasmicHomeCta.module.css"; // plasmic-import: YAVEsIb01Kc/css
import SphereIcon from "./icons/PlasmicIcon__Sphere"; // plasmic-import: zecC-M8go-fG/icon
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.freeBox__nZn8R)}
      >
        <div
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.freeBox__nx38G)}
        >
          <input
      ...
      {(hasVariant(globalVariants, "screen", "mobile") ? false : true) ? (
        <div className={classNames(defaultcss.all, sty.freeBox__azLtl)}>
          <SphereIcon
