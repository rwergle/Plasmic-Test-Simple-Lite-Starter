...
import * as sty from "./PlasmicTopSection.module.css"; // plasmic-import: S-miPNfQ95y/css
import heroImageYPtpbI8W5Qrp from "./images/heroImage.png"; // plasmic-import: YPtpbI8w5QRP/picture
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.freeBox__mDl4B)}
      >
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.freeBox__gwjw0)}
        >
          <div className={classNames(defaultcss.all, sty.freeBox__mWpDe)}>
            <div
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.freeBox___1XNP)}
        >
          <LinkButton
            className={classNames("__wab_instance", sty.linkButton__wy7ZU)}
            text={"Start free trial"}
            type={"solidBlue"}
          />

          <LinkButton
            className={classNames("__wab_instance", sty.linkButton__kULe)}
            text={"Learn more"}
            type={"solidBlack"}
          />
        </p.Stack>

        <div className={classNames(defaultcss.all, sty.freeBox__h5KnN)}>
          <img
