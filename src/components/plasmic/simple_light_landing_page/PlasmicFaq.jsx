...
import * as sty from "./PlasmicFaq.module.css"; // plasmic-import: d5mixM9aNL8G/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.freeBox__aesss)}
      >
        <div className={classNames(defaultcss.all, sty.freeBox___6MQju)}>
          <div className={classNames(defaultcss.all, sty.freeBox__pCXvj)}>
            {p.renderPlasmicSlot({
