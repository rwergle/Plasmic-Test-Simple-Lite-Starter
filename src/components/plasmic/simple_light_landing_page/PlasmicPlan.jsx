...
import BaseCard from "../../BaseCard"; // plasmic-import: OyskBcF8tcOU/component
...
import * as sty from "./PlasmicPlan.module.css"; // plasmic-import: zZla4dtjQ0yp/css
...
function PlasmicPlan__RenderFunc(props) {
  ...
  return (
    ...
    >
      <div className={classNames(defaultcss.all, sty.freeBox__yY4J1)}>
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.freeBox__hmCth)}
        >
          {p.renderPlasmicSlot({
          ...
          {p.renderPlasmicSlot({
            defaultContents: (
              <p.Stack
                as={"div"}
                hasGap={true}
                className={classNames(defaultcss.all, sty.freeBox__smsaO)}
              >
                <Bullet
                  className={classNames("__wab_instance", sty.bullet__nlIql)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__qVvU0)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__uMfNw)}
                />
              </p.Stack>
            ),
          ...
          <div className={classNames(defaultcss.all, sty.freeBox___02Zch)}>
            {p.renderPlasmicSlot({
              defaultContents: (
